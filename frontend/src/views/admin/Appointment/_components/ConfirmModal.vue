...
<template>
  <div v-if="isOpen" class="fixed inset-0 z-[60] flex items-center justify-center p-4">
    ...
    <!-- Modal Content -->
    <div class="relative bg-white rounded-xl w-full max-w-sm shadow-xl overflow-hidden transform transition-all">
        <div class="p-6">
            ...
            <p class="text-gray-600 mb-6 ml-14">{{ message }}</p>
            ...
            <div class="flex justify-end gap-3">
                ...
                <button 
                    @click="$emit('confirm')"
                    class="px-4 py-2 text-white rounded-lg font-medium transition-colors flex items-center gap-2"
                    :class="[
